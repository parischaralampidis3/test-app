<x-app-layout>
    ...
    <section class="container mx-auto">
        <div class="flex justify-around items-center">
            ...
            <a class="mt-10 ml-4 bg-green-600 text-white font-bold py-2 px-2 hover:underline" href="dashboard">Go at the
                main page</a>
        </div>
        <div class="flex flex-column justify-center items-center mt-10">
            ...
            <form method="POST" action="{{ url('create') }}">
                ...
                <div class="flex flex-col">
                    ...
                    <input class="rounded-md mt-5" type="text" name="address" id="address" value="{{ old('address') }}"
                        required>
                    @error('address')
                        <p>{{ $message }}</p>
                    @enderror
                ...
                <div class="flex flex-col">
                    ...
                    <input class="rounded-md mt-5" type="email" name="email" id="email" value="{{ old('email') }}"
                        required>
                    @error('email')
                        <p>{{ $message }}</p>
                    @enderror
