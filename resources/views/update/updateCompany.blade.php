    ...
    <div class="flex flex-column justify-center items-center">
        <form method="POST" action="{{ route('company.update', $company->id) }}">
            ...
            <div class="flex flex-col">
                ...
                <input class="rounded-md mt-5" type="text" name="name" id="name" value="{{ old('name', $company->name) }}">
            ...
            <div class="flex flex-col">
                ...
                <input  class="rounded-md mt-5"  type="text" name="address" id="address" value="{{ old('address', $company->address) }}">
                @error('address')
                    <p>{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex flex-col">
                ...
                <input  class="rounded-md mt-5"  type="text" name="email" id="email" value="{{ old('email', $company->email) }}">
                @error('email')
                    <p>{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex flex-col">
                ...
                <input  class="rounded-md mt-5" type="text" name="website" id="website" value="{{ old('website', $company->website) }}">
                @error('website')
                    <p>{{ $message }}</p>
                @enderror
            </div>
